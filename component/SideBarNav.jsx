...
export default function SideBarNav() {
  ...
  return (
    <div className="antialiased bg-gray-50 dark:bg-gray-900">
          ...
          <div className="flex justify-start items-center">
            ...
            >
              <img
                ...
                alt="Flowbite Logo"
              />
              <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white font-iranyekan">
                داشبورد انرژی
              </span>
            </a>
      ...
      {/* Sidebar */}
      <aside
        className={`${drawer ? '' : 'translate-x-full'} fixed top-0 right-0 left-0 z-40 w-64 h-screen pt-14 transition-transform bg-white border-r border-gray-200 md:translate-x-0 dark:bg-gray-800 dark:border-gray-700`}
        aria-label="Sidenav"
      ...
      <main className="p-4 md:mr-64 h-auto pt-20">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="border-2 border-dashed rounded-lg border-gray-300 dark:border-gray-600 h-48 md:h-72" />
			...
			<div className={`${drawer ? 'block' : 'hidden'} bg-gray-900/50 dark:bg-gray-900/80 fixed inset-0 z-30`} onClick={() => setDrawer(false)}></div>
    </div>
  );
}
